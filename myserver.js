...
const server = http.createServer(async(req, res) => {
    ...
    else if(req.method === 'GET' && req.url === '/css/companyReviews.css') {
        sendStaticFile(res, 'css/companyReviews.css', 'text/css')
    }
    ...
    else if(req.method === 'GET' && req.url === '/components/reviews/reviewsSearchBar.js') {
        sendStaticFile(res, 'components/reviews/reviewsSearchBar.js', 'application/javascript')
    }
    ...
    else if(req.method === 'GET' && req.url === '/views/companyReviewsView.js') {
        sendStaticFile(res, 'views/companyReviewsView.js', 'application/javascript')
    }
    else if(req.method === 'GET' && req.url === '/views/companyAboutView.js') {
        sendStaticFile(res, 'views/companyAboutView.js', 'application/javascript')
    }
    else if(req.method === 'GET' && req.url === '/companyReviewsState.js') {
        sendStaticFile(res, 'companyReviewsState.js', 'application/javascript')
    }
    ...
    else if(req.method === 'GET' && req.url === '/components/profile/reviewsProfile.js') {
        sendStaticFile(res, 'components/profile/reviewsProfile.js', 'application/javascript')
    }
    ...
    else if(req.method === 'GET' && req.url === '/components/common/pagination.js') {
        sendStaticFile(res, '/components/common/pagination.js', 'application/javascript')
    }
